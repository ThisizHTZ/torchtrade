...
evaluates it on a holdout split, and writes artifacts to `outputs/local_backtest/`.
See [`examples/end_to_end/local_backtest/README.md`](examples/end_to_end/local_backtest/README.md)
for the task-by-task workflow.
